...
public class ExcelLib  {
	...
	public String getExcelData(String sheetName,int rowNum,int colNum) throws InvalidFormatException, IOException{
		...
		FileInputStream fis=new FileInputStream(ExcelSheetPath+File.separator+File.separator+"src"+File.separator+File.separator+"main"+File.separator+File.separator+"resources"+File.separator+File.separator+"TestData.xlsx");
	...
	public static String getInstanceId(String sheetName,int rowNum,int colNum){
		...
		String ExcelSheetPath = System.getProperty("user.dir");
		try {
			fis = new FileInputStream(ExcelSheetPath+File.separator+File.separator+"src"+File.separator+File.separator+"main"+File.separator+File.separator+"resources"+File.separator+File.separator+"TestData.xlsx");
	...
	public void setExcelData(String sheetName,int rowNum,int colNum,String setName) throws InvalidFormatException, IOException{
		...
		FileOutputStream fos=new FileOutputStream(ExcelSheetPath+File.separator+File.separator+"src"+File.separator+File.separator+"main"+File.separator+File.separator+"resources"+File.separator+File.separator+"TestData.xlsx");
		wb.write(fos);
		}
